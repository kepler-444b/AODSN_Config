#ifndef MODEL_PANEL_2KEY_H
#define MODEL_PANEL_2KEY_H
...
namespace Ui {
class ModelPanel2Key;
}

class ModelPanel2Key : public QWidget
{
    Q_OBJECT

public:
    explicit ModelPanel2Key(QWidget *parent = nullptr);
    ~ModelPanel2Key();
...
private:
    Ui::ModelPanel2Key *ui;
    QList<QPushButton*> m_buttons;
    uint8_t m_addr = 0;
    QVector<scene_save_t> m_sceneList;
};

#endif // MODEL_PANEL_2KEY_H
