#ifndef MODEL_PANEL_4KEY_H
#define MODEL_PANEL_4KEY_H
...
namespace Ui {
class ModelPanel4Key;
}

class ModelPanel4Key : public QWidget
{
    Q_OBJECT

public:
    explicit ModelPanel4Key(QWidget *parent = nullptr);
    ~ModelPanel4Key();
...
private:
    Ui::ModelPanel4Key *ui;
    QList<QPushButton*> m_buttons;
    uint8_t m_addr = 0;
    QVector<scene_save_t> m_sceneList;
};

#endif // MODEL_PANEL_4KEY_H
