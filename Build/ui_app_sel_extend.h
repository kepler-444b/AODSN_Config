...
public:
    ...
    void setupUi(QDialog *DialogExtend)
    {
        if (DialogExtend->objectName().isEmpty())
            DialogExtend->setObjectName(QString::fromUtf8("DialogExtend"));
        ...
        horizontalLayout = new QHBoxLayout(sel_dev);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        led_ex = new QRadioButton(sel_dev);
        led_ex->setObjectName(QString::fromUtf8("led_ex"));

        horizontalLayout->addWidget(led_ex);

        relay_ex = new QRadioButton(sel_dev);
        relay_ex->setObjectName(QString::fromUtf8("relay_ex"));

        horizontalLayout->addWidget(relay_ex);
